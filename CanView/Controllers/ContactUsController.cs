...
namespace CanView.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        {
            ViewData["ContactUs"] = db.ContactUs.ToList();
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID")] ContactUs contactUs)
        {
            if (ModelState.IsValid)
            {
